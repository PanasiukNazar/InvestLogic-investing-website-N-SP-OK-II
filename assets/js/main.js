(function() {
  ...
  // Scroll behavior for header class toggle
  ...
  // Hide mobile nav on menu link click
  ...
  // Initialize AOS (Animate On Scroll) after window load
  function aosInit() {
  ...
  function initSwiper() {
    ...
    document.querySelectorAll(".init-swiper").forEach(function(swiperElement) {
      ...
      if (swiperElement.classList.contains("swiper-tab")) {
        // Your custom pagination initialization if any
  ...
  // Animate skills progress bars on waypoint reveal
    ...
    document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
      ...
      isotopeItem.querySelectorAll('.isotope-filters li').forEach(function(filters) {
        filters.addEventListener('click', function() {
          ...
          if (typeof AOS !== 'undefined') {
            AOS.refresh(); // refresh AOS animations on filter change
          }
        });
      });
    });
